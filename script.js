/* Logic and Data Fetching for SteoType (X-PROFILE UI SOFT DARK THEME) */
...
function renderProducts() {
  ...
  filtered.forEach((item, index) => {
    ...
    const cardHtml = `
      <div class="product-card bg-gray-800 rounded-2xl border ${inCart ? 'border-blue-500 shadow-blue-900/20 shadow-lg' : 'border-gray-700'} fade-in-down overflow-hidden ${!isReady ? 'opacity-60' : ''}" data-username="${item.username}" style="animation-delay: ${index * 0.05}s">
        ...
        <div class="px-4 pb-4">
          ...
          <div class="flex gap-4 text-[15px] text-gray-400 mb-4">
            ...
            <p><span class="text-gray-100 font-bold val-followers">${item.followers}</span> Followers</p>
          </div>
